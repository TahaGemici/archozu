...
00002000 <.text>:
    ...
    2206:	0e802783          	lw	a5,232(zero) # 0xe8
    ...
    223a:	0ea02223          	sw	a0,228(zero) # 0xe4
    223e:	0e402503          	lw	a0,228(zero) # 0xe4
    2242:	458d                	li	a1,3
    2244:	fff54513          	not	a0,a0
    2248:	2055                	jal	0x22ec
    224a:	0e404503          	lbu	a0,228(zero) # 0xe4
    224e:	28a5                	jal	0x22c6
    2250:	28b1                	jal	0x22ac
    2252:	0ea02223          	sw	a0,228(zero) # 0xe4
    2256:	a021                	j	0x225e
    2258:	470d                	li	a4,3
    225a:	fee78be3          	beq	a5,a4,0x2250
    225e:	0e802783          	lw	a5,232(zero) # 0xe8
    2262:	40b6                	lw	ra,76(sp)
    2264:	42a6                	lw	t0,72(sp)
    2266:	0785                	addi	a5,a5,1
    2268:	8b8d                	andi	a5,a5,3
    226a:	0ef02423          	sw	a5,232(zero) # 0xe8
...
000026b0 <.text.delay_us>:
    ...
    26d8:	4705                	li	a4,1
    26da:	0ee02e23          	sw	a4,252(zero) # 0xfc
    26de:	0fc02703          	lw	a4,252(zero) # 0xfc
...
000028ba <.text.i2c_main>:
    ...
    28ea:	03402783          	lw	a5,52(zero) # 0x34
    ...
    2900:	03402783          	lw	a5,52(zero) # 0x34
    2904:	0017b793          	seqz	a5,a5
    2908:	02f02a23          	sw	a5,52(zero) # 0x34
    290c:	bff9                	j	0x28ea
    290e:	4509                	li	a0,2
...
000029ca <.text.timer_main>:
    ...
    29ec:	03002703          	lw	a4,48(zero) # 0x30
...
00002a34 <.text.usb_main>:
    ...
    2a36:	d422                	sw	s0,40(sp)
    2a38:	d226                	sw	s1,36(sp)
    2a3a:	d04a                	sw	s2,32(sp)
    2a3c:	d606                	sw	ra,44(sp)
    2a3e:	ce4e                	sw	s3,28(sp)
    2a40:	cc52                	sw	s4,24(sp)
    2a42:	ca56                	sw	s5,20(sp)
    2a44:	c85a                	sw	s6,16(sp)
    2a46:	c65e                	sw	s7,12(sp)
    2a48:	0e002823          	sw	zero,240(zero) # 0xf0
    2a4c:	6941                	lui	s2,0x10
    2a4e:	0f002783          	lw	a5,240(zero) # 0xf0
    2a52:	cf89                	beqz	a5,0x2a6c
    2a54:	0f002783          	lw	a5,240(zero) # 0xf0
    2a58:	4711                	li	a4,4
    2a5a:	17fd                	addi	a5,a5,-1
    2a5c:	0cf76063          	bltu	a4,a5,0x2b1c
    2a60:	078a                	slli	a5,a5,0x2
    2a62:	00000713          	li	a4,0
    2a66:	97ba                	add	a5,a5,a4
    2a68:	439c                	lw	a5,0(a5)
    2a6a:	8782                	jr	a5
    2a6c:	00092783          	lw	a5,0(s2) # 0x10000
    2a70:	0ff7f793          	zext.b	a5,a5
    2a74:	0ef02a23          	sw	a5,244(zero) # 0xf4
    2a78:	0e002823          	sw	zero,240(zero) # 0xf0
    2a7c:	0f402783          	lw	a5,244(zero) # 0xf4
    2a80:	eb91                	bnez	a5,0x2a94
    2a82:	0f002783          	lw	a5,240(zero) # 0xf0
    2a86:	d7e1                	beqz	a5,0x2a4e
    2a88:	0f002503          	lw	a0,240(zero) # 0xf0
    2a8c:	0ff57513          	zext.b	a0,a0
    2a90:	31bd                	jal	0x26fe
    2a92:	bf75                	j	0x2a4e
    2a94:	0f402783          	lw	a5,244(zero) # 0xf4
    2a98:	8385                	srli	a5,a5,0x1
    2a9a:	0ef02a23          	sw	a5,244(zero) # 0xf4
    2a9e:	0f002783          	lw	a5,240(zero) # 0xf0
    2aa2:	0785                	addi	a5,a5,1
    2aa4:	0ef02823          	sw	a5,240(zero) # 0xf0
    2aa8:	bfd1                	j	0x2a7c
    2aaa:	000f4437          	lui	s0,0xf4
    2aae:	64c1                	lui	s1,0x10
    2ab0:	24040413          	addi	s0,s0,576 # 0xf4240
    2ab4:	4088                	lw	a0,0(s1)
    2ab6:	0542                	slli	a0,a0,0x10
    2ab8:	8141                	srli	a0,a0,0x10
    2aba:	3151                	jal	0x273e
    2abc:	8522                	mv	a0,s0
    2abe:	3ecd                	jal	0x26b0
    2ac0:	bfd5                	j	0x2ab4
    2ac2:	a001                	j	0x2ac2
    2ac4:	0f402503          	lw	a0,244(zero) # 0xf4
    2ac8:	31b9                	jal	0x2716
    2aca:	0ea02a23          	sw	a0,244(zero) # 0xf4
    2ace:	bfdd                	j	0x2ac4
    2ad0:	6a41                	lui	s4,0x10
    2ad2:	4901                	li	s2,0
    2ad4:	ea700b13          	li	s6,-345
    2ad8:	f1f00b93          	li	s7,-225
    2adc:	fffa0a93          	addi	s5,s4,-1 # 0xffff
    2ae0:	4501                	li	a0,0
    2ae2:	31a9                	jal	0x272c
    2ae4:	0e100413          	li	s0,225
    2ae8:	028409b3          	mul	s3,s0,s0
    2aec:	08700493          	li	s1,135
    2af0:	99ca                	add	s3,s3,s2
    2af2:	02948533          	mul	a0,s1,s1
    2af6:	14f5                	addi	s1,s1,-3 # 0xfffd
    2af8:	954e                	add	a0,a0,s3
    2afa:	0ff57513          	zext.b	a0,a0
    2afe:	313d                	jal	0x272c
    2b00:	ff6499e3          	bne	s1,s6,0x2af2
    2b04:	146d                	addi	s0,s0,-5
    2b06:	ff7411e3          	bne	s0,s7,0x2ae8
    2b0a:	000a2783          	lw	a5,0(s4)
    2b0e:	0157f7b3          	and	a5,a5,s5
    2b12:	993e                	add	s2,s2,a5
    2b14:	b7f1                	j	0x2ae0
    2b16:	392d                	jal	0x2750
    2b18:	3911                	jal	0x272c
    2b1a:	bff5                	j	0x2b16
    2b1c:	50b2                	lw	ra,44(sp)
    2b1e:	5422                	lw	s0,40(sp)
    2b20:	5492                	lw	s1,36(sp)
    2b22:	5902                	lw	s2,32(sp)
    2b24:	49f2                	lw	s3,28(sp)
    2b26:	4a62                	lw	s4,24(sp)
    2b28:	4ad2                	lw	s5,20(sp)
    2b2a:	4b42                	lw	s6,16(sp)
    2b2c:	4bb2                	lw	s7,12(sp)
    2b2e:	6145                	addi	sp,sp,48
    2b30:	8082                	ret

Disassembly of section .text.usb_interrupt:

00002b32 <.text.usb_interrupt>:
    2b32:	8082                	ret

Disassembly of section .text.debug_main:

00002b34 <.text.debug_main>:
    2b34:	711d                	addi	sp,sp,-96
    2b36:	caa6                	sw	s1,84(sp)
    2b38:	c4d2                	sw	s4,72(sp)
    2b3a:	4515                	li	a0,5
    2b3c:	6a41                	lui	s4,0x10
    2b3e:	6485                	lui	s1,0x1
    2b40:	c8ca                	sw	s2,80(sp)
    2b42:	c2d6                	sw	s5,68(sp)
    2b44:	c0da                	sw	s6,64(sp)
    2b46:	de5e                	sw	s7,60(sp)
    2b48:	dc62                	sw	s8,56(sp)
    2b4a:	ce86                	sw	ra,92(sp)
    2b4c:	cca2                	sw	s0,88(sp)
    2b4e:	c6ce                	sw	s3,76(sp)
    2b50:	da66                	sw	s9,52(sp)
    2b52:	d86a                	sw	s10,48(sp)
    2b54:	d66e                	sw	s11,44(sp)
    2b56:	6ac1                	lui	s5,0x10
    2b58:	365d                	jal	0x26fe
    2b5a:	0a11                	addi	s4,s4,4 # 0x10004
    2b5c:	4b05                	li	s6,1
    2b5e:	38848493          	addi	s1,s1,904 # 0x1388
    2b62:	4b89                	li	s7,2
    2b64:	6c05                	lui	s8,0x1
    2b66:	000aa783          	lw	a5,0(s5) # 0x10000
    2b6a:	07c2                	slli	a5,a5,0x10
    2b6c:	83c1                	srli	a5,a5,0x10
    2b6e:	0ef01623          	sh	a5,236(zero) # 0xec
    2b72:	0ec05783          	lhu	a5,236(zero) # 0xec
    2b76:	07c2                	slli	a5,a5,0x10
    2b78:	83c1                	srli	a5,a5,0x10
    2b7a:	00fa2023          	sw	a5,0(s4)
    2b7e:	0ec05783          	lhu	a5,236(zero) # 0xec
    2b82:	d3f5                	beqz	a5,0x2b66
    2b84:	000aa783          	lw	a5,0(s5)
    2b88:	07c2                	slli	a5,a5,0x10
    2b8a:	83c1                	srli	a5,a5,0x10
    2b8c:	ffe5                	bnez	a5,0x2b84
    2b8e:	0ec05783          	lhu	a5,236(zero) # 0xec
    2b92:	01079713          	slli	a4,a5,0x10
    2b96:	8341                	srli	a4,a4,0x10
    2b98:	05678e63          	beq	a5,s6,0x2bf4
    2b9c:	fd7715e3          	bne	a4,s7,0x2b66
    2ba0:	4981                	li	s3,0
    2ba2:	4c81                	li	s9,0
    2ba4:	01099413          	slli	s0,s3,0x10
    2ba8:	8041                	srli	s0,s0,0x10
    2baa:	02040d13          	addi	s10,s0,32
    2bae:	02000613          	li	a2,32
    2bb2:	85ce                	mv	a1,s3
    2bb4:	850a                	mv	a0,sp
    2bb6:	0d42                	slli	s10,s10,0x10
    2bb8:	3c59                	jal	0x264e
    2bba:	8d8a                	mv	s11,sp
    2bbc:	010d5d13          	srli	s10,s10,0x10
    2bc0:	8522                	mv	a0,s0
    2bc2:	365d                	jal	0x2768
    2bc4:	03a00513          	li	a0,58
    2bc8:	3695                	jal	0x272c
    2bca:	02000513          	li	a0,32
    2bce:	3eb9                	jal	0x272c
    2bd0:	000da503          	lw	a0,0(s11)
    2bd4:	0411                	addi	s0,s0,4
    2bd6:	0442                	slli	s0,s0,0x10
    2bd8:	36e9                	jal	0x27a2
    2bda:	36cd                	jal	0x27bc
    2bdc:	8526                	mv	a0,s1
    2bde:	8041                	srli	s0,s0,0x10
    2be0:	3cc1                	jal	0x26b0
    2be2:	0d91                	addi	s11,s11,4
    2be4:	fda41ee3          	bne	s0,s10,0x2bc0
    2be8:	0ca1                	addi	s9,s9,8
    2bea:	02098993          	addi	s3,s3,32
    2bee:	fb8c9be3          	bne	s9,s8,0x2ba4
    2bf2:	bf95                	j	0x2b66
    2bf4:	4401                	li	s0,0
    2bf6:	00241513          	slli	a0,s0,0x2
    2bfa:	0542                	slli	a0,a0,0x10
    2bfc:	8141                	srli	a0,a0,0x10
    2bfe:	36ad                	jal	0x2768
    2c00:	03a00513          	li	a0,58
    2c04:	3625                	jal	0x272c
    2c06:	8526                	mv	a0,s1
    2c08:	3465                	jal	0x26b0
    2c0a:	00340993          	addi	s3,s0,3
    2c0e:	fff40c93          	addi	s9,s0,-1
    2c12:	02000513          	li	a0,32
    2c16:	3e19                	jal	0x272c
    2c18:	00299793          	slli	a5,s3,0x2
    2c1c:	4388                	lw	a0,0(a5)
    2c1e:	19fd                	addi	s3,s3,-1
    2c20:	3649                	jal	0x27a2
    2c22:	8526                	mv	a0,s1
    2c24:	3471                	jal	0x26b0
    2c26:	ff9996e3          	bne	s3,s9,0x2c12
    2c2a:	3e49                	jal	0x27bc
    2c2c:	0411                	addi	s0,s0,4
    2c2e:	80040793          	addi	a5,s0,-2048
    2c32:	f3f1                	bnez	a5,0x2bf6
    2c34:	bf0d                	j	0x2b66

Disassembly of section .text.debug_interrupt:

00002c36 <.text.debug_interrupt>:
    2c36:	8082                	ret
