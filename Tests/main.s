...
0000200e <uart_read>:
    ...
    2010:	07c1                	addi	a5,a5,16 # 6010 <__GNU_EH_FRAME_HDR+0x379c>
    2012:	4709                	li	a4,2
...
00002028 <uart_write>:
    ...
    202e:	4705                	li	a4,1
    2030:	07c1                	addi	a5,a5,16 # 6010 <__GNU_EH_FRAME_HDR+0x379c>
...
00002048 <i2c_write>:
    ...
    2050:	4705                	li	a4,1
    2052:	07c1                	addi	a5,a5,16 # 8010 <__GNU_EH_FRAME_HDR+0x579c>
...
00002064 <i2c_read>:
    ...
    2068:	4711                	li	a4,4
    206a:	07c1                	addi	a5,a5,16 # 8010 <__GNU_EH_FRAME_HDR+0x579c>
...
00002080 <s25fl128s_wren>:
    ...
    2084:	0799                	addi	a5,a5,6 # 80000006 <__GNU_EH_FRAME_HDR+0x7fffd792>
    2086:	6729                	lui	a4,0xa
    2088:	c31c                	sw	a5,0(a4)
    208a:	67a9                	lui	a5,0xa
    208c:	02878793          	addi	a5,a5,40 # a028 <__GNU_EH_FRAME_HDR+0x77b4>
    2090:	4705                	li	a4,1
...
0000209a <s25fl128s_wrdi>:
    ...
    209e:	0791                	addi	a5,a5,4 # 80000004 <__GNU_EH_FRAME_HDR+0x7fffd790>
    20a0:	6729                	lui	a4,0xa
    20a2:	c31c                	sw	a5,0(a4)
    20a4:	67a9                	lui	a5,0xa
    20a6:	02878793          	addi	a5,a5,40 # a028 <__GNU_EH_FRAME_HDR+0x77b4>
    20aa:	4705                	li	a4,1
...
000020b4 <s25fl128s_clsr>:
    ...
    20b8:	03078793          	addi	a5,a5,48 # 80000030 <__GNU_EH_FRAME_HDR+0x7fffd7bc>
    20bc:	6729                	lui	a4,0xa
    20be:	c31c                	sw	a5,0(a4)
    20c0:	67a9                	lui	a5,0xa
    20c2:	02878793          	addi	a5,a5,40 # a028 <__GNU_EH_FRAME_HDR+0x77b4>
    20c6:	4705                	li	a4,1
...
000020d0 <s25fl128s_reset>:
    ...
    20d4:	0f078793          	addi	a5,a5,240 # 800000f0 <__GNU_EH_FRAME_HDR+0x7fffd87c>
    20d8:	6729                	lui	a4,0xa
    20da:	c31c                	sw	a5,0(a4)
    20dc:	67a9                	lui	a5,0xa
    20de:	02878793          	addi	a5,a5,40 # a028 <__GNU_EH_FRAME_HDR+0x77b4>
    20e2:	4705                	li	a4,1
...
000020ec <s25fl128s_rdid>:
    ...
    20f4:	19f70713          	addi	a4,a4,415 # 8000019f <__GNU_EH_FRAME_HDR+0x7fffd92b>
    20f8:	07c2                	slli	a5,a5,0x10
    20fa:	97ba                	add	a5,a5,a4
    20fc:	6729                	lui	a4,0xa
    20fe:	c31c                	sw	a5,0(a4)
    2100:	67a9                	lui	a5,0xa
    2102:	02878793          	addi	a5,a5,40 # a028 <__GNU_EH_FRAME_HDR+0x77b4>
    2106:	4705                	li	a4,1
    ...
    2114:	4781                	li	a5,0
    2116:	06a1                	addi	a3,a3,8 # a008 <__GNU_EH_FRAME_HDR+0x7794>
...
00002130 <s25fl128s_rdsr1>:
    ...
    2134:	10578793          	addi	a5,a5,261 # 80000105 <__GNU_EH_FRAME_HDR+0x7fffd891>
    2138:	6729                	lui	a4,0xa
    213a:	c31c                	sw	a5,0(a4)
    213c:	67a9                	lui	a5,0xa
    213e:	02878793          	addi	a5,a5,40 # a028 <__GNU_EH_FRAME_HDR+0x77b4>
    2142:	4705                	li	a4,1
...
00002154 <s25fl128s_rdsr2>:
    ...
    2158:	10778793          	addi	a5,a5,263 # 80000107 <__GNU_EH_FRAME_HDR+0x7fffd893>
    215c:	6729                	lui	a4,0xa
    215e:	c31c                	sw	a5,0(a4)
    2160:	67a9                	lui	a5,0xa
    2162:	02878793          	addi	a5,a5,40 # a028 <__GNU_EH_FRAME_HDR+0x77b4>
    2166:	4705                	li	a4,1
...
00002178 <s25fl128s_rdcr>:
    ...
    217c:	13578793          	addi	a5,a5,309 # 80000135 <__GNU_EH_FRAME_HDR+0x7fffd8c1>
    2180:	6729                	lui	a4,0xa
    2182:	c31c                	sw	a5,0(a4)
    2184:	67a9                	lui	a5,0xa
    2186:	02878793          	addi	a5,a5,40 # a028 <__GNU_EH_FRAME_HDR+0x77b4>
    218a:	4705                	li	a4,1
...
0000219c <s25fl128s_read_id>:
    ...
    21a4:	99078793          	addi	a5,a5,-1648 # 80011990 <__GNU_EH_FRAME_HDR+0x8000f11c>
    21a8:	6729                	lui	a4,0xa
    21aa:	c31c                	sw	a5,0(a4)
    21ac:	67a9                	lui	a5,0xa
    21ae:	02878793          	addi	a5,a5,40 # a028 <__GNU_EH_FRAME_HDR+0x77b4>
    21b2:	4705                	li	a4,1
...
000021c4 <s25fl128s_res>:
    ...
    21c8:	9ab78793          	addi	a5,a5,-1621 # 800019ab <__GNU_EH_FRAME_HDR+0x7ffff137>
    21cc:	6729                	lui	a4,0xa
    21ce:	c31c                	sw	a5,0(a4)
    21d0:	67a9                	lui	a5,0xa
    21d2:	02878793          	addi	a5,a5,40 # a028 <__GNU_EH_FRAME_HDR+0x77b4>
    21d6:	4705                	li	a4,1
...
000021e8 <s25fl128s_wrr>:
    ...
    21f0:	50178793          	addi	a5,a5,1281 # 80010501 <__GNU_EH_FRAME_HDR+0x8000dc8d>
    21f4:	6729                	lui	a4,0xa
    21f6:	c31c                	sw	a5,0(a4)
    21f8:	67a9                	lui	a5,0xa
    21fa:	02878793          	addi	a5,a5,40 # a028 <__GNU_EH_FRAME_HDR+0x77b4>
    21fe:	4705                	li	a4,1
...
00002208 <s25fl128s_read>:
    ...
    2210:	90370713          	addi	a4,a4,-1789 # 80001903 <__GNU_EH_FRAME_HDR+0x7ffff08f>
    ...
    2222:	02878793          	addi	a5,a5,40 # a028 <__GNU_EH_FRAME_HDR+0x77b4>
    2226:	4705                	li	a4,1
    ...
    2234:	4781                	li	a5,0
    2236:	06a1                	addi	a3,a3,8 # a008 <__GNU_EH_FRAME_HDR+0x7794>
...
00002250 <s25fl128s_pp>:
    ...
    2258:	d0270713          	addi	a4,a4,-766 # 80001d02 <__GNU_EH_FRAME_HDR+0x7ffff48e>
    ...
    226a:	4701                	li	a4,0
    226c:	0521                	addi	a0,a0,8 # a008 <__GNU_EH_FRAME_HDR+0x7794>
    226e:	00c74c63          	blt	a4,a2,2286 <s25fl128s_pp+0x36>
    2272:	6729                	lui	a4,0xa
    2274:	c31c                	sw	a5,0(a4)
    2276:	67a9                	lui	a5,0xa
    2278:	02878793          	addi	a5,a5,40 # a028 <__GNU_EH_FRAME_HDR+0x77b4>
    227c:	4705                	li	a4,1
    ...
    2292:	0705                	addi	a4,a4,1 # a001 <__GNU_EH_FRAME_HDR+0x778d>
...
0000229a <s25fl128s_se>:
    ...
    22a2:	5d878793          	addi	a5,a5,1496 # 800205d8 <__GNU_EH_FRAME_HDR+0x8001dd64>
    22a6:	6729                	lui	a4,0xa
    22a8:	c31c                	sw	a5,0(a4)
    22aa:	67a9                	lui	a5,0xa
    22ac:	02878793          	addi	a5,a5,40 # a028 <__GNU_EH_FRAME_HDR+0x77b4>
    22b0:	4705                	li	a4,1
...
000022ba <s25fl128s_dor>:
    ...
    22c2:	23b70713          	addi	a4,a4,571 # 8000223b <__GNU_EH_FRAME_HDR+0x7ffff9c7>
    ...
    22d4:	02878793          	addi	a5,a5,40 # a028 <__GNU_EH_FRAME_HDR+0x77b4>
    22d8:	4705                	li	a4,1
    ...
    22e6:	4781                	li	a5,0
    22e8:	06a1                	addi	a3,a3,8 # a008 <__GNU_EH_FRAME_HDR+0x7794>
...
00002302 <s25fl128s_qor>:
    ...
    230a:	36b70713          	addi	a4,a4,875 # 8000236b <__GNU_EH_FRAME_HDR+0x7ffffaf7>
    ...
    231c:	02878793          	addi	a5,a5,40 # a028 <__GNU_EH_FRAME_HDR+0x77b4>
    2320:	4705                	li	a4,1
    ...
    232e:	4781                	li	a5,0
    2330:	06a1                	addi	a3,a3,8 # a008 <__GNU_EH_FRAME_HDR+0x7794>
...
0000234a <s25fl128s_qpp>:
    ...
    2352:	f3270713          	addi	a4,a4,-206 # 80001f32 <__GNU_EH_FRAME_HDR+0x7ffff6be>
    ...
    2368:	4781                	li	a5,0
    236a:	06a1                	addi	a3,a3,8 # a008 <__GNU_EH_FRAME_HDR+0x7794>
    236c:	00c7ca63          	blt	a5,a2,2380 <s25fl128s_qpp+0x36>
    2370:	67a9                	lui	a5,0xa
    2372:	02878793          	addi	a5,a5,40 # a028 <__GNU_EH_FRAME_HDR+0x77b4>
    2376:	4705                	li	a4,1
...
00002392 <qspi_custom_write>:
    ...
    23be:	4701                	li	a4,0
    23c0:	0621                	addi	a2,a2,8 # a008 <__GNU_EH_FRAME_HDR+0x7794>
    23c2:	00f74c63          	blt	a4,a5,23da <qspi_custom_write+0x48>
    23c6:	67a9                	lui	a5,0xa
    23c8:	0107a023          	sw	a6,0(a5) # a000 <__GNU_EH_FRAME_HDR+0x778c>
    23cc:	4705                	li	a4,1
    ...
    23e6:	0705                	addi	a4,a4,1 # a001 <__GNU_EH_FRAME_HDR+0x778d>
...
000023ec <qspi_custom_read>:
    ...
    2410:	01072023          	sw	a6,0(a4) # a000 <__GNU_EH_FRAME_HDR+0x778c>
    2414:	4685                	li	a3,1
    ...
    2426:	4701                	li	a4,0
    2428:	0621                	addi	a2,a2,8 # a008 <__GNU_EH_FRAME_HDR+0x7794>
...
00002472 <timer_disable>:
    ...
    2474:	0007a623          	sw	zero,12(a5) # c00c <__GNU_EH_FRAME_HDR+0x9798>
    2478:	8082                	ret
