...
00002000 <.text>:
    ...
    2026:	0ce01a23          	sh	a4,212(zero) # 0xd4
    202a:	0d405703          	lhu	a4,212(zero) # 0xd4
    ...
    2046:	0d405683          	lhu	a3,212(zero) # 0xd4
    204a:	4721                	li	a4,8
    ...
    208e:	119000ef          	jal	0x29a6
    2092:	16b000ef          	jal	0x29fc
	...
    21fe:	0000                	unimp
    2200:	7139                	addi	sp,sp,-64
    2202:	cc3e                	sw	a5,24(sp)
    2204:	ce3a                	sw	a4,28(sp)
    2206:	0ec02703          	lw	a4,236(zero) # 0xec
    ...
    2228:	0e002623          	sw	zero,236(zero) # 0xec
    ...
    224e:	30200073          	mret
    2252:	0d405783          	lhu	a5,212(zero) # 0xd4
...
0000268c <.text.delay_us>:
    ...
    26b4:	4705                	li	a4,1
    26b6:	0ee02623          	sw	a4,236(zero) # 0xec
    26ba:	0ec02703          	lw	a4,236(zero) # 0xec
...
000029a6 <.text.timer_main>:
    ...
    29c8:	02002703          	lw	a4,32(zero) # 0x20
...
00002a10 <.text.usb_main>:
    ...
    2a12:	cc22                	sw	s0,24(sp)
    2a14:	ca26                	sw	s1,20(sp)
    2a16:	c84a                	sw	s2,16(sp)
    2a18:	c64e                	sw	s3,12(sp)
    2a1a:	c452                	sw	s4,8(sp)
    2a1c:	ce06                	sw	ra,28(sp)
    2a1e:	6a41                	lui	s4,0x10
    2a20:	4991                	li	s3,4
    2a22:	000a2783          	lw	a5,0(s4) # 0x10000
    2a26:	0ff7f793          	zext.b	a5,a5
    2a2a:	0ef02223          	sw	a5,228(zero) # 0xe4
    2a2e:	0c002e23          	sw	zero,220(zero) # 0xdc
    2a32:	0e402783          	lw	a5,228(zero) # 0xe4
    2a36:	e3d1                	bnez	a5,0x2aba
    2a38:	0dc02703          	lw	a4,220(zero) # 0xdc
    2a3c:	0d802783          	lw	a5,216(zero) # 0xd8
    2a40:	00f70763          	beq	a4,a5,0x2a4e
    2a44:	0dc02503          	lw	a0,220(zero) # 0xdc
    2a48:	0ff57513          	zext.b	a0,a0
    2a4c:	3179                	jal	0x26da
    2a4e:	0dc02783          	lw	a5,220(zero) # 0xdc
    2a52:	0cf02c23          	sw	a5,216(zero) # 0xd8
    2a56:	0dc02783          	lw	a5,220(zero) # 0xdc
    2a5a:	05378463          	beq	a5,s3,0x2aa2
    2a5e:	06f9e963          	bltu	s3,a5,0x2ad0
    2a62:	4705                	li	a4,1
    2a64:	06e78c63          	beq	a5,a4,0x2adc
    2a68:	4709                	li	a4,2
    2a6a:	fae79ce3          	bne	a5,a4,0x2a22
    2a6e:	4501                	li	a0,0
    2a70:	3961                	jal	0x2708
    2a72:	4481                	li	s1,0
    2a74:	28000993          	li	s3,640
    2a78:	16800a13          	li	s4,360
    2a7c:	4401                	li	s0,0
    2a7e:	0e002503          	lw	a0,224(zero) # 0xe0
    2a82:	9526                	add	a0,a0,s1
    2a84:	9522                	add	a0,a0,s0
    2a86:	0ff57513          	zext.b	a0,a0
    2a8a:	0405                	addi	s0,s0,1
    2a8c:	39b5                	jal	0x2708
    2a8e:	ff3418e3          	bne	s0,s3,0x2a7e
    2a92:	0485                	addi	s1,s1,1
    2a94:	ff4494e3          	bne	s1,s4,0x2a7c
    2a98:	0e002783          	lw	a5,224(zero) # 0xe0
    2a9c:	0785                	addi	a5,a5,1
    2a9e:	0ef02023          	sw	a5,224(zero) # 0xe0
    2aa2:	000f4437          	lui	s0,0xf4
    2aa6:	64c1                	lui	s1,0x10
    2aa8:	24040413          	addi	s0,s0,576 # 0xf4240
    2aac:	4088                	lw	a0,0(s1)
    2aae:	0542                	slli	a0,a0,0x10
    2ab0:	8141                	srli	a0,a0,0x10
    2ab2:	31a5                	jal	0x271a
    2ab4:	8522                	mv	a0,s0
    2ab6:	3ed9                	jal	0x268c
    2ab8:	bfd5                	j	0x2aac
    2aba:	0e402783          	lw	a5,228(zero) # 0xe4
    2abe:	8385                	srli	a5,a5,0x1
    2ac0:	0ef02223          	sw	a5,228(zero) # 0xe4
    2ac4:	0dc02783          	lw	a5,220(zero) # 0xdc
    2ac8:	0785                	addi	a5,a5,1
    2aca:	0cf02e23          	sw	a5,220(zero) # 0xdc
    2ace:	b795                	j	0x2a32
    2ad0:	4715                	li	a4,5
    2ad2:	f4e798e3          	bne	a5,a4,0x2a22
    2ad6:	3999                	jal	0x272c
    2ad8:	3905                	jal	0x2708
    2ada:	b7a1                	j	0x2a22
    2adc:	0e002503          	lw	a0,224(zero) # 0xe0
    2ae0:	3909                	jal	0x26f2
    2ae2:	0ea02023          	sw	a0,224(zero) # 0xe0
    2ae6:	b761                	j	0x2a6e

Disassembly of section .text.usb_interrupt:

00002ae8 <.text.usb_interrupt>:
    2ae8:	8082                	ret

Disassembly of section .text.debug_main:

00002aea <.text.debug_main>:
    2aea:	711d                	addi	sp,sp,-96
    2aec:	caa6                	sw	s1,84(sp)
    2aee:	c4d2                	sw	s4,72(sp)
    2af0:	4515                	li	a0,5
    2af2:	6a41                	lui	s4,0x10
    2af4:	6485                	lui	s1,0x1
    2af6:	c8ca                	sw	s2,80(sp)
    2af8:	c2d6                	sw	s5,68(sp)
    2afa:	c0da                	sw	s6,64(sp)
    2afc:	de5e                	sw	s7,60(sp)
    2afe:	dc62                	sw	s8,56(sp)
    2b00:	ce86                	sw	ra,92(sp)
    2b02:	cca2                	sw	s0,88(sp)
    2b04:	c6ce                	sw	s3,76(sp)
    2b06:	da66                	sw	s9,52(sp)
    2b08:	d86a                	sw	s10,48(sp)
    2b0a:	d66e                	sw	s11,44(sp)
    2b0c:	6ac1                	lui	s5,0x10
    2b0e:	36f1                	jal	0x26da
    2b10:	0a11                	addi	s4,s4,4 # 0x10004
    2b12:	4b05                	li	s6,1
    2b14:	38848493          	addi	s1,s1,904 # 0x1388
    2b18:	4b89                	li	s7,2
    2b1a:	6c05                	lui	s8,0x1
    2b1c:	000aa783          	lw	a5,0(s5) # 0x10000
    2b20:	07c2                	slli	a5,a5,0x10
    2b22:	83c1                	srli	a5,a5,0x10
    2b24:	0cf01b23          	sh	a5,214(zero) # 0xd6
    2b28:	0d605783          	lhu	a5,214(zero) # 0xd6
    2b2c:	07c2                	slli	a5,a5,0x10
    2b2e:	83c1                	srli	a5,a5,0x10
    2b30:	00fa2023          	sw	a5,0(s4)
    2b34:	0d605783          	lhu	a5,214(zero) # 0xd6
    2b38:	d3f5                	beqz	a5,0x2b1c
    2b3a:	000aa783          	lw	a5,0(s5)
    2b3e:	07c2                	slli	a5,a5,0x10
    2b40:	83c1                	srli	a5,a5,0x10
    2b42:	ffe5                	bnez	a5,0x2b3a
    2b44:	0d605783          	lhu	a5,214(zero) # 0xd6
    2b48:	01079713          	slli	a4,a5,0x10
    2b4c:	8341                	srli	a4,a4,0x10
    2b4e:	05678e63          	beq	a5,s6,0x2baa
    2b52:	fd7715e3          	bne	a4,s7,0x2b1c
    2b56:	4981                	li	s3,0
    2b58:	4c81                	li	s9,0
    2b5a:	01099413          	slli	s0,s3,0x10
    2b5e:	8041                	srli	s0,s0,0x10
    2b60:	02040d13          	addi	s10,s0,32
    2b64:	02000613          	li	a2,32
    2b68:	85ce                	mv	a1,s3
    2b6a:	850a                	mv	a0,sp
    2b6c:	0d42                	slli	s10,s10,0x10
    2b6e:	3c75                	jal	0x262a
    2b70:	8d8a                	mv	s11,sp
    2b72:	010d5d13          	srli	s10,s10,0x10
    2b76:	8522                	mv	a0,s0
    2b78:	36f1                	jal	0x2744
    2b7a:	03a00513          	li	a0,58
    2b7e:	3669                	jal	0x2708
    2b80:	02000513          	li	a0,32
    2b84:	3651                	jal	0x2708
    2b86:	000da503          	lw	a0,0(s11)
    2b8a:	0411                	addi	s0,s0,4
    2b8c:	0442                	slli	s0,s0,0x10
    2b8e:	3ec5                	jal	0x277e
    2b90:	3121                	jal	0x2798
    2b92:	8526                	mv	a0,s1
    2b94:	8041                	srli	s0,s0,0x10
    2b96:	3cdd                	jal	0x268c
    2b98:	0d91                	addi	s11,s11,4
    2b9a:	fda41ee3          	bne	s0,s10,0x2b76
    2b9e:	0ca1                	addi	s9,s9,8
    2ba0:	02098993          	addi	s3,s3,32
    2ba4:	fb8c9be3          	bne	s9,s8,0x2b5a
    2ba8:	bf95                	j	0x2b1c
    2baa:	4401                	li	s0,0
    2bac:	00241513          	slli	a0,s0,0x2
    2bb0:	0542                	slli	a0,a0,0x10
    2bb2:	8141                	srli	a0,a0,0x10
    2bb4:	3e41                	jal	0x2744
    2bb6:	03a00513          	li	a0,58
    2bba:	36b9                	jal	0x2708
    2bbc:	8526                	mv	a0,s1
    2bbe:	34f9                	jal	0x268c
    2bc0:	00340993          	addi	s3,s0,3
    2bc4:	fff40c93          	addi	s9,s0,-1
    2bc8:	02000513          	li	a0,32
    2bcc:	3e35                	jal	0x2708
    2bce:	00299793          	slli	a5,s3,0x2
    2bd2:	4388                	lw	a0,0(a5)
    2bd4:	19fd                	addi	s3,s3,-1
    2bd6:	3665                	jal	0x277e
    2bd8:	8526                	mv	a0,s1
    2bda:	3c4d                	jal	0x268c
    2bdc:	ff9996e3          	bne	s3,s9,0x2bc8
    2be0:	3e65                	jal	0x2798
    2be2:	0411                	addi	s0,s0,4
    2be4:	80040793          	addi	a5,s0,-2048
    2be8:	f3f1                	bnez	a5,0x2bac
    2bea:	bf0d                	j	0x2b1c

Disassembly of section .text.debug_interrupt:

00002bec <.text.debug_interrupt>:
    2bec:	8082                	ret

Disassembly of section .text.main_interrupt:

00002bee <.text.main_interrupt>:
    2bee:	01c05683          	lhu	a3,28(zero) # 0x1c
    2bf2:	01c05783          	lhu	a5,28(zero) # 0x1c
    2bf6:	0686                	slli	a3,a3,0x1
    2bf8:	83bd                	srli	a5,a5,0xf
    2bfa:	8fd5                	or	a5,a5,a3
    2bfc:	07c2                	slli	a5,a5,0x10
    2bfe:	83c1                	srli	a5,a5,0x10
    2c00:	00f01e23          	sh	a5,28(zero) # 0x1c
    2c04:	01c05703          	lhu	a4,28(zero) # 0x1c
    2c08:	67c1                	lui	a5,0x10
    2c0a:	0742                	slli	a4,a4,0x10
    2c0c:	8341                	srli	a4,a4,0x10
    2c0e:	c3d8                	sw	a4,4(a5)
    2c10:	8082                	ret
