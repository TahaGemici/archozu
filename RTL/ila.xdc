...
connect_debug_port u_ila_0/probe1 [get_nets [list {bus/I2C_master/state[0]} {bus/I2C_master/state[1]} {bus/I2C_master/state[2]}]]
create_debug_port u_ila_0 probe
...
connect_debug_port u_ila_0/probe3 [get_nets [list sda_io_IBUF]]
