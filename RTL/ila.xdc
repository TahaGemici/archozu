...
connect_debug_port u_ila_0/probe0 [get_nets [list {io_IBUF[0]} {io_IBUF[1]} {io_IBUF[2]} {io_IBUF[3]}]]
...
connect_debug_port u_ila_0/probe2 [get_nets [list {bus/QSPI_master/state_q_reg[0]} {bus/QSPI_master/state_q_reg[1]}]]
create_debug_port u_ila_0 probe
