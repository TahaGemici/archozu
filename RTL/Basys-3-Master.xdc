...
connect_debug_port u_ila_0/probe1 [get_nets [list {data_wdata[0]} {data_wdata[1]} {data_wdata[2]} {data_wdata[3]} {data_wdata[4]} {data_wdata[5]} {data_wdata[6]} {data_wdata[7]} {data_wdata[8]} {data_wdata[9]} {data_wdata[10]} {data_wdata[11]} {data_wdata[12]} {data_wdata[13]} {data_wdata[14]} {data_wdata[15]} {data_wdata[16]} {data_wdata[17]} {data_wdata[18]} {data_wdata[19]} {data_wdata[20]} {data_wdata[21]} {data_wdata[22]} {data_wdata[23]} {data_wdata[24]} {data_wdata[25]} {data_wdata[26]} {data_wdata[27]} {data_wdata[28]} {data_wdata[29]} {data_wdata[30]} {data_wdata[31]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 4 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list {data_be[0]} {data_be[1]} {data_be[2]} {data_be[3]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 12 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list {data_addr[2]} {data_addr[3]} {data_addr[4]} {data_addr[5]} {data_addr[6]} {data_addr[7]} {data_addr[8]} {data_addr[9]} {data_addr[10]} {data_addr[11]} {data_addr[12]} {data_addr[13]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe4]
set_property port_width 1 [get_debug_ports u_ila_0/probe4]
connect_debug_port u_ila_0/probe4 [get_nets [list data_req]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe5]
set_property port_width 1 [get_debug_ports u_ila_0/probe5]
connect_debug_port u_ila_0/probe5 [get_nets [list irq_ack]]
...
connect_debug_port u_ila_1/probe0 [get_nets [list {instr_rdata[0]} {instr_rdata[1]} {instr_rdata[2]} {instr_rdata[3]} {instr_rdata[4]} {instr_rdata[5]} {instr_rdata[6]} {instr_rdata[7]} {instr_rdata[8]} {instr_rdata[9]} {instr_rdata[10]} {instr_rdata[11]} {instr_rdata[12]} {instr_rdata[13]} {instr_rdata[14]} {instr_rdata[15]} {instr_rdata[16]} {instr_rdata[17]} {instr_rdata[18]} {instr_rdata[19]} {instr_rdata[20]} {instr_rdata[21]} {instr_rdata[22]} {instr_rdata[23]} {instr_rdata[24]} {instr_rdata[25]} {instr_rdata[26]} {instr_rdata[27]} {instr_rdata[28]} {instr_rdata[29]} {instr_rdata[30]} {instr_rdata[31]}]]
create_debug_port u_ila_1 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_1/probe1]
set_property port_width 32 [get_debug_ports u_ila_1/probe1]
connect_debug_port u_ila_1/probe1 [get_nets [list {data_rdata[0]} {data_rdata[1]} {data_rdata[2]} {data_rdata[3]} {data_rdata[4]} {data_rdata[5]} {data_rdata[6]} {data_rdata[7]} {data_rdata[8]} {data_rdata[9]} {data_rdata[10]} {data_rdata[11]} {data_rdata[12]} {data_rdata[13]} {data_rdata[14]} {data_rdata[15]} {data_rdata[16]} {data_rdata[17]} {data_rdata[18]} {data_rdata[19]} {data_rdata[20]} {data_rdata[21]} {data_rdata[22]} {data_rdata[23]} {data_rdata[24]} {data_rdata[25]} {data_rdata[26]} {data_rdata[27]} {data_rdata[28]} {data_rdata[29]} {data_rdata[30]} {data_rdata[31]}]]
create_debug_port u_ila_1 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_1/probe2]
set_property port_width 1 [get_debug_ports u_ila_1/probe2]
connect_debug_port u_ila_1/probe2 [get_nets [list data_rvalid]]
create_debug_port u_ila_1 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_1/probe3]
set_property port_width 1 [get_debug_ports u_ila_1/probe3]
connect_debug_port u_ila_1/probe3 [get_nets [list instr_rvalid]]
